            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img src="/Screenshot 2024-10-08 at 9.36.51 PM.png" />
                    ...
                    <div class="col-span-4 md:col-span-3 lg:col-span-4 lg:pl-8">
                        ...
                        <form  class="mt-6">
                            ...
                            <button type="submit" class="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-purple-600">contact us</button>
                        </form>
                    </div>
                </div>
